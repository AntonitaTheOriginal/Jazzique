...
export default function ChordAnalyzer({ chords, keyResult, tempo }: ChordAnalyzerProps) {
          ...
          <div className="grid grid-cols-2 gap-3">
            {chords.map((chord, i) => (
              <motion.button
                ...
                style={{
                  background: i === 0 ? 'rgba(201,168,76,0.1)' : 'rgba(0,0,0,0.2)',
                  border: i === 0 ? '1px solid rgba(201,168,76,0.25)' : '1px solid rgba(255,255,255,0.04)',
                }}
              >
                <div className="flex items-center justify-between w-full">
                  <div className="font-display font-bold" style={{ color: i === 0 ? '#C9A84C' : '#C0B090' }}>
                    {chord.name}
                  </div>
